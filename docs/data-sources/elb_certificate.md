...
# g42cloud_elb_certificate

Use this data source to get the certificate in G42Cloud Dedicated Load Balance (Dedicated ELB).
...
data "g42cloud_elb_certificate" "test" {
