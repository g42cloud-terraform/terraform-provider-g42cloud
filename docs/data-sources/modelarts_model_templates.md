...
* `engine` - (Optional, String) The AI engine.  
  ...
  **PyTorch**, **PyTorch1.0**, **TensorFlow**, and **TensorFlow1.8**.

* `environment` - (Optional, String) Model runtime environment.  
  The valid values is **python3.6**.
...
* `engine` - The AI engine.  
  The valid values are **Caffe**, **MXNet**, **PyTorch**, and **TensorFlow**.
