...
# g42cloud_apig_signature_associate

Use this resource to bind the APIs to the signature within G42Cloud.

-> A signature can only create one `g42cloud_apig_signature_associate` resource.
...
resource "g42cloud_apig_signature_associate" "test" {
...
```bash
$ terraform import g42cloud_apig_signature_associate.test <instance_id>/<signature_id>
```
