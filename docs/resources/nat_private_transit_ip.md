...
Manages a transit IP resource of the **private** NAT within G42Cloud.
...
```bash
$ terraform import g42cloud_nat_private_transit_ip.test 5a1d921c-1df5-477d-8481-317b3fb47b5d
```
