...
# g42cloud_aom_service_discovery_rule

Manages an AOM service discovery rule resource within G42Cloud.
...
```hcl
resource "g42cloud_aom_service_discovery_rule" "discovery_rule" {
  name                   = "test-rule"
  priority               = 9999
...
```
$ terraform import g42cloud_aom_service_discovery_rule.alarm_rule rule_name
```
