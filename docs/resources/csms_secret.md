...
# g42cloud_csms_secret

Manages CSMS(Cloud Secret Management Service) secrets within G42Cloud.
...
```hcl
resource "g42cloud_csms_secret" "test1" {
  name        = "test_secret"
...
```hcl
resource "g42cloud_csms_secret" "test2" {
  name        = "mysql_admin"
...
```shell
terraform import g42cloud_csms_secret.test 93cba7f5-550b-45dc-912e-277b3296fb27/test_secret
```
