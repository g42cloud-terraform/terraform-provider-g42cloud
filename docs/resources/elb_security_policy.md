...
# g42cloud_elb_security_policy

Manages an ELB security policy resource within G42Cloud.

## Example Usage

```hcl
resource "g42cloud_elb_security_policy" "test" {
...
* `listenerRef` - The listener which the security policy associated with.
...
```
$ terraform import g42cloud_elb_security_policy.test 0ce123456a00f2591fabc00385ff1234
```
