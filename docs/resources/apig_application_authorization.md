...
# g42cloud_apig_application_authorization

Using this resoruce to authorize APIs for application, allowing it to access the published APIs within G42Cloud.

-> For an application, an environment can only create one `g42cloud_apig_application_authorization` resource (all
...
```bash
$ terraform import g42cloud_apig_application_authorization.test <instance_id>/<env_id>/<application_id>
```
