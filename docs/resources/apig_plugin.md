...
# g42cloud_apig_plugin

Manages a plugin resource within G42Cloud.
...
resource "g42cloud_apig_plugin" "test" {
...
* `content` - (Required, String) Specifies the configuration details for plugin.
  + For `CORS` plugins, you can refer to this [document](https://docs.g42cloud.com/usermanual/apig/apig_03_0021.html).
  + For `HTTP Response Header Management` plugins, you can refer to this [document](https://docs.g42cloud.com/usermanual/apig/apig_03_0022.html).
  + For `Request Throttling 2.0` plugins, you can refer to this [document](https://docs.g42cloud.com/usermanual/apig/apig_03_0054.html).
  + For `Kafka Log Push` plugins, you can refer to this [document](https://docs.g42cloud.com/usermanual/apig/apig_03_0061.html).
  + For `Circuit Breaker` plugins, you can refer to this [document](https://docs.g42cloud.com/usermanual/apig/apig_03_0023.html).
...
```bash
$ terraform import g42cloud_apig_plugin.test <instance_id>/<id>
```
