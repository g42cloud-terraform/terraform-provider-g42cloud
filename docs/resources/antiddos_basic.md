...
# g42cloud_antiddos_basic

Manages Cloud Native Anti-DDos Basic resource within G42Cloud.
...
resource "g42cloud_antiddos_basic" "antiddos_1" {
  eip_id            = var.eip_id
...
* `traffic_threshold` - (Required, Int) Specifies the traffic cleaning threshold in Mbps.
  The value can be 10, 30, 50, 70, 100, 120, 150, 200, 250, 300 Mbps.
...
```
$ terraform import g42cloud_antiddos_basic.antiddos_1 c5256d47-8f9e-4ae7-9943-6e77e3d8bd2d
```
