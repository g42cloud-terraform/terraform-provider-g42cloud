...
Manages a SWR image retention policy within G42Cloud.
...
resource "g42cloud_swr_image_retention_policy" "test" {
...
The [tag_selectors](#SwrImageRetentionPolicy_TagSelector) structure is documented below.
...
```bash
$ terraform import g42cloud_swr_image_retention_policy.test <organization_name>/<repository_name>/<retention_id>
```
