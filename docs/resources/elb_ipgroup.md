...
# g42cloud_elb_ipgroup

Manages a Dedicated ELB Ip Group resource within G42Cloud.

## Example Usage

```hcl
resource "g42cloud_elb_ipgroup" "basic" {
  name        = "basic"
...
```
$ terraform import g42cloud_elb_ipgroup.group_1 5c20fdad-7288-11eb-b817-0255ac10158b
```
...
```
resource "g42cloud_elb_ipgroup" "group_1" {
    ...
  lifecycle {
    ignore_changes = [
