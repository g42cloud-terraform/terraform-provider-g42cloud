...
Manages a SMN message template resource within G42Cloud.
...
resource "g42cloud_smn_message_template" "test"{
  name     = var.name
...
```bash
$ terraform import g42cloud_smn_message_template.test <message_template_id>
```
