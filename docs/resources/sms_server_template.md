...
# g42cloud_sms_server_template

Manages an SMS server template resource within G42Cloud.
...
```hcl
data "g42cloud_availability_zones" "demo" {}

resource "g42cloud_sms_server_template" "demo" {
  name              = "demo"
  availability_zone = data.g42cloud_availability_zones.demo.names[0]
}
```
...
```sh
terraform import g42cloud_sms_server_template.demo 4618ccaf-b4d7-43b9-b958-3df3b885126d
```
