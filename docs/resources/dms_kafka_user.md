...
# g42cloud_dms_kafka_user

Manages a DMS kafka user resource within G42Cloud.
...
resource "g42cloud_dms_kafka_user" "user" {
...
```
terraform import g42cloud_dms_kafka_user.user c8057fe5-23a8-46ef-ad83-c0055b4e0c5c/user_1
```
