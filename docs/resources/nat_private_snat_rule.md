...
Manages an SNAT rule resource of the **private** NAT within G42Cloud.
...
```bash
$ terraform import g42cloud_nat_private_snat_rule.test df9b61e9-79c1-4a75-bfab-736e224ced71
```
