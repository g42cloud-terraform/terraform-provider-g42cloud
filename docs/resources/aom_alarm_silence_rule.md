...
# g42cloud_aom_alarm_silence_rule

Manages an AOM alarm silence rule resource within G42Cloud.

## Example Usage

```hcl
resource "g42cloud_aom_alarm_silence_rule" "test" {
  name        = "test_rule"
...
```bash
$ terraform import g42cloud_aom_alarm_silence_rule.test test_rule
```
