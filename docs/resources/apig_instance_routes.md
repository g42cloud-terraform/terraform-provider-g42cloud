...
# g42cloud_apig_instance_routes

Using this resource to manage the instance routes within G42Cloud.
...
resource "g42cloud_apig_instance_routes" "test" {
...
```bash
$ terraform import g42cloud_apig_instance_routes.test 128001b3c5eb4d3e91a8da9c0f46420f
```
