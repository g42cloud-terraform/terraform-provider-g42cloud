...
Manages a DLI Spark template resource within G42Cloud.

## Example Usage

```hcl
resource "g42cloud_dli_template_spark" "test" {
  name        = "demo"
...
* `configurations` - (Optional, Map) The configuration items of the DLI spark.  
  ...
  If you want to enable the **access metadata** of DLI spark in G42Cloud, please set
...
```bash
$ terraform import g42cloud_dli_template_spark.test 9680ed93-fa3f-47e5-8471-ff6e7e1a6499
```
