...
# g42cloud_vpc_address_group

Manages a VPC IP address group resource within G42Cloud.
...
```hcl
resource "g42cloud_vpc_address_group" "ipv4" {
  name = "group-ipv4"
...
```hcl
resource "g42cloud_vpc_address_group" "ipv6" {
  name       = "group-ipv6"
  ip_version = 6
...
```bash
$ terraform import g42cloud_vpc_address_group.test bc96f6b0-ca2c-42ee-b719-0f26bc9c8661
```
...
```hcl
resource "g42cloud_vpc_address_group" "test" {
  ...
