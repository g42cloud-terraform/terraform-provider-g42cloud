...
# g42cloud_aom_alarm_rule

Manages an AOM alarm rule resource within G42Cloud.

## Example Usage

```hcl
resource "g42cloud_aom_alarm_rule" "alarm_rule" {  
  name        = "test-rule"
  alarm_level = 3
...
-> **NOTE:** You can get more information about `metric_name`, `namespace`, `unit` and `dimensions`
  from [Metric Overview](https://docs.g42cloud.com/usermanual/aom/aom_06_0014.html).
...
```
$ terraform import g42cloud_aom_alarm_rule.alarm_rule 966746116613832710
```
