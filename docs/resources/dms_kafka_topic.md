...
# g42cloud_dms_kafka_topic

Manages a DMS kafka topic resource within G42Cloud.
...
resource "g42cloud_dms_kafka_topic" "topic" {
...
```sh
terraform import g42cloud_dms_kafka_topic.topic c8057fe5-23a8-46ef-ad83-c0055b4e0c5c/topic_1
```
