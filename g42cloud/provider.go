...
func Provider() *schema.Provider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"g42cloud_dli_agency":                dli.ResourceDliAgency(),
			"g42cloud_dli_database":              dli.ResourceDliSqlDatabaseV1(),
			"g42cloud_dli_datasource_connection": dli.ResourceDatasourceConnection(),
			"g42cloud_dli_datasource_auth":       dli.ResourceDatasourceAuth(),
			"g42cloud_dli_global_variable":       dli.ResourceGlobalVariable(),
			"g42cloud_dli_package":               dli.ResourceDliPackageV2(),
			"g42cloud_dli_permission":            dli.ResourceDliPermission(),
			"g42cloud_dli_queue":                 dli.ResourceDliQueue(),
			"g42cloud_dli_spark_job":             dli.ResourceDliSparkJobV2(),
			"g42cloud_dli_sql_job":               dli.ResourceSqlJob(),
			"g42cloud_dli_table":                 dli.ResourceDliTable(),
			"g42cloud_dli_template_sql":          dli.ResourceSQLTemplate(),
			"g42cloud_dli_template_flink":        dli.ResourceFlinkTemplate(),
			"g42cloud_dli_template_spark":        dli.ResourceSparkTemplate(),
