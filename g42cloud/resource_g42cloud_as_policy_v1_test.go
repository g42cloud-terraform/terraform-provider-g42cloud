		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckASV1PolicyExists("g42cloud_as_policy.acc_as_policy", &asPolicy),
				),
			},
		},
	})
...
resource "g42cloud_as_group" "acc_as_group"{
  scaling_group_name       = "%s"
  scaling_configuration_id = g42cloud_as_configuration.acc_as_config.id
...
resource "g42cloud_as_policy" "acc_as_policy"{
  scaling_policy_name = "%s"
  scaling_policy_type = "SCHEDULED"
  scaling_group_id    = g42cloud_as_group.acc_as_group.id
