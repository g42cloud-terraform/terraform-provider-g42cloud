		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckRouteV2DataSourceID("data.g42cloud_vpc_route.by_id"),
					resource.TestCheckResourceAttr(
						"data.g42cloud_vpc_route.by_id", "type", "peering"),
					resource.TestCheckResourceAttr(
						"data.g42cloud_vpc_route.by_id", "destination", "192.168.0.0/16"),
					testAccCheckRouteV2DataSourceID("data.g42cloud_vpc_route.by_vpc_id"),
					resource.TestCheckResourceAttr(
						"data.g42cloud_vpc_route.by_vpc_id", "type", "peering"),
					resource.TestCheckResourceAttr(
						"data.g42cloud_vpc_route.by_vpc_id", "destination", "192.168.0.0/16"),
				),
			},
		},
	})
...
data "g42cloud_vpc_route" "by_id" {
  id = g42cloud_vpc_route.test.id
}

data "g42cloud_vpc_route" "by_vpc_id" {
  vpc_id = g42cloud_vpc_route.test.vpc_id
}
`, rName, rName+"2", rName)
}
