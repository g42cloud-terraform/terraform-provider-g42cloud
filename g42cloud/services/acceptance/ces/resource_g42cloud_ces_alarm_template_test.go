...
func TestAccCesAlarmTemplate_basic(t *testing.T) {
	...
	rName := "g42cloud_ces_alarm_template.test"
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(rName, "policies.0.filter", "variance"),
					resource.TestCheckResourceAttr(rName, "policies.0.comparison_operator", "<"),
					...
					resource.TestCheckResourceAttr(rName, "policies.0.suppress_duration", "600"),
				),
			},
			{
				Config: testCesAlarmTemplate_basic_update2(updateName),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "name", updateName),
					resource.TestCheckResourceAttr(rName, "description", "It is an update template"),
					...
					resource.TestCheckResourceAttr(rName, "policies.0.dimension_name", "mongodb_instance_id"),
					resource.TestCheckResourceAttr(rName, "policies.0.metric_name", "mongo003_insert_ps"),
					resource.TestCheckResourceAttr(rName, "policies.0.period", "1200"),
					resource.TestCheckResourceAttr(rName, "policies.0.filter", "min"),
					resource.TestCheckResourceAttr(rName, "policies.0.comparison_operator", "="),
					resource.TestCheckResourceAttr(rName, "policies.0.value", "900"),
					resource.TestCheckResourceAttr(rName, "policies.0.unit", "times/second"),
					resource.TestCheckResourceAttr(rName, "policies.0.count", "5"),
					resource.TestCheckResourceAttr(rName, "policies.0.alarm_level", "3"),
			...
			{
				Config: testCesAlarmTemplate_basic_update3(updateName),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "name", updateName),
					resource.TestCheckResourceAttr(rName, "description", "It is an update template"),
					...
					resource.TestCheckResourceAttr(rName, "policies.0.dimension_name", "mongodb_instance_id"),
					resource.TestCheckResourceAttr(rName, "policies.0.metric_name", "mongo003_insert_ps"),
					resource.TestCheckResourceAttr(rName, "policies.0.period", "14400"),
					resource.TestCheckResourceAttr(rName, "policies.0.filter", "max"),
					resource.TestCheckResourceAttr(rName, "policies.0.comparison_operator", ">="),
					resource.TestCheckResourceAttr(rName, "policies.0.value", "300"),
					resource.TestCheckResourceAttr(rName, "policies.0.unit", "times/second"),
					resource.TestCheckResourceAttr(rName, "policies.0.count", "5"),
					resource.TestCheckResourceAttr(rName, "policies.0.alarm_level", "4"),
					resource.TestCheckResourceAttr(rName, "policies.0.suppress_duration", "10800"),
				),
			},
			{
				Config: testCesAlarmTemplate_basic_update4(updateName),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "name", updateName),
					resource.TestCheckResourceAttr(rName, "description", "It is an update template"),
					...
					resource.TestCheckResourceAttr(rName, "policies.0.dimension_name", "mongodb_instance_id"),
					resource.TestCheckResourceAttr(rName, "policies.0.metric_name", "mongo003_insert_ps"),
					resource.TestCheckResourceAttr(rName, "policies.0.period", "86400"),
					resource.TestCheckResourceAttr(rName, "policies.0.filter", "sum"),
					resource.TestCheckResourceAttr(rName, "policies.0.comparison_operator", "<="),
					resource.TestCheckResourceAttr(rName, "policies.0.value", "300"),
					resource.TestCheckResourceAttr(rName, "policies.0.unit", "times/second"),
					resource.TestCheckResourceAttr(rName, "policies.0.count", "5"),
					resource.TestCheckResourceAttr(rName, "policies.0.alarm_level", "3"),
					resource.TestCheckResourceAttr(rName, "policies.0.suppress_duration", "43200"),
				),
			},
			{
				ResourceName:      rName,
...
func testCesAlarmTemplate_basic_update2(name string) string {
	return fmt.Sprintf(`
resource "g42cloud_ces_alarm_template" "test" {
  name        = "%s"
  description = "It is an update template"
...
func testCesAlarmTemplate_basic_update3(name string) string {
	return fmt.Sprintf(`
resource "g42cloud_ces_alarm_template" "test" {
  name        = "%s"
  description = "It is an update template"
...
func testCesAlarmTemplate_basic_update4(name string) string {
	return fmt.Sprintf(`
resource "g42cloud_ces_alarm_template" "test" {
  name        = "%s"
  description = "It is an update template"
