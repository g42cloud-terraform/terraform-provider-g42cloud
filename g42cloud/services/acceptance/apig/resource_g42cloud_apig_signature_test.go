...
func TestAccSignature_basic(t *testing.T) {
	var (
		...
		rName1 = "g42cloud_apig_signature.with_key"
		rName2 = "g42cloud_apig_signature.without_key"
...
resource "g42cloud_apig_signature" "with_key" {
...
resource "g42cloud_apig_signature" "without_key" {
  instance_id = g42cloud_apig_instance.test.id
