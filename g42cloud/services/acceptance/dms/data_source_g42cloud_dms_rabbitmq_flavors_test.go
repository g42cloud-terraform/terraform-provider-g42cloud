...
func TestAccRabbitMQFlavorsDataSource_basic(t *testing.T) {
	dataSourceName := "data.g42cloud_dms_rabbitmq_flavors.test"
...
func testAccDatasourceDmsRabbitMQFlavors_basic() string {
	return `
data "g42cloud_dms_rabbitmq_flavors" "baisc" {
  type = "cluster"
}
...
locals {
  test_refer   = data.g42cloud_dms_rabbitmq_flavors.baisc.flavors[0]
  test_results = data.g42cloud_dms_rabbitmq_flavors.test
}
