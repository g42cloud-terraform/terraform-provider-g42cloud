...
func TestAccKafkaFlavorsDataSource_basic(t *testing.T) {
	dataSourceName := "data.g42cloud_dms_kafka_flavors.test"
...
data "g42cloud_dms_kafka_flavors" "baisc" {
  type = "cluster"
}
...
locals {
  test_refer   = data.g42cloud_dms_kafka_flavors.baisc.flavors[0]
  test_results = data.g42cloud_dms_kafka_flavors.test
}
