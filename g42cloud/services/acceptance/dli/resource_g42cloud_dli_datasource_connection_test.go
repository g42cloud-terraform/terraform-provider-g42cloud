...
func TestAccDatasourceConnection_basic(t *testing.T) {
	...
	rName := "g42cloud_dli_datasource_connection.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(rName, "vpc_id", "g42cloud_vpc.test", "id"),
					resource.TestCheckResourceAttrPair(rName, "subnet_id", "g42cloud_vpc_subnet.test", "id"),
...
resource "g42cloud_dli_datasource_connection" "test" {
  ...
  queues = [g42cloud_dli_queue.test.name]
