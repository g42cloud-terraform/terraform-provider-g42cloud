...
func TestAccPrivateTransitIp_basic(t *testing.T) {
	var (
		...
		rName1 = "g42cloud_nat_private_transit_ip.test"
		rName2 = "g42cloud_nat_private_transit_ip.random_ip_address"
...
resource "g42cloud_nat_private_transit_ip" "random_ip_address" {
  subnet_id             = g42cloud_vpc_subnet.test.id
  enterprise_project_id = "0"
