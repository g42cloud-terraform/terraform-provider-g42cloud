		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDNSV2ZoneExists("g42cloud_dns_zone.zone_1", &zone),
					resource.TestCheckResourceAttr(
						"g42cloud_dns_zone.zone_1", "description", "a zone"),
				),
			},
			{
				ResourceName:      "g42cloud_dns_zone.zone_1",
				ImportState:       true,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr(
						"g42cloud_dns_zone.zone_1", "ttl", regexp.MustCompile("^[0-9]+$")),
				),
			},
		},
	})
